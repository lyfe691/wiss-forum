        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="text-muted-foreground">
                <li className="mb-2">
                  <Link to="/login" className="hover:underline hover:text-primary transition-colors">Login</Link>
                </li>
                <li className="mb-2">
                  <Link to="/register" className="hover:underline hover:text-primary transition-colors">Register</Link>
                </li>
                <li className="mb-2">
                  <Link to="/profile" className="hover:underline hover:text-primary transition-colors">Profile</Link>
                </li>
              </ul>
            </div>
            <div>
